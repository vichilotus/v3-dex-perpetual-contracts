...
describe('\n📌 ### Test Example: Simple Trade ###\n', function () {
    ...
    it('Position: 0 | BTC | Open Position', async function () {
        ...
        await relayNodeFulfill(relayNode, prices, 0, false) // no slippage
    ...
    it('Position: 1 | ETH | Open Position', async function () {
        ...
        await relayNodeFulfill(relayNode, prices, 0.1, false) // slippage 0.1%
    ...
    it('Position: 0 | BTC | Close Position (Profit)', async function () {
        ...
        // 2 simulate relayNode fulfill request
        const prices = priceList[4] // priceList set 4
        await relayNodeFulfill(relayNode, prices, 1.0, false) // no slippage 1%
    ...
    it('Position: 1 | ETH | Close Position (Loss)', async function () {
        ...
        await relayNodeFulfill(relayNode, prices, 0.85, false) // slippage 0.85%
    ...
    it('Position: 2 | BNB | Open Position', async function () {
        ...
        await relayNodeFulfill(relayNode, prices, 1.5, false) // slippage 1.5%
...
async function relayNodeFulfill(relayNode, prices, slippage, checkLastPrice) {
