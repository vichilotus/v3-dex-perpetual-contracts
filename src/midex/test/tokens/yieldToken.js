...
describe('YieldToken', function () {
    ...
    it('claim', async () => {
        ...
        await reportGasUsed(provider, tx0, 'transfer0 gas used')
        ...
        await reportGasUsed(provider, tx1, 'transfer1 gas used')
        ...
        await reportGasUsed(provider, tx2, 'transfer2 gas used')
        ...
        await reportGasUsed(provider, tx3, 'transfer3 gas used')
    })
