...
describe('PositionRouter', function () {
    ...
    it('inits', async () => {
        ...
        expect(await positionRouter.governor()).eq(wallet.address)
    })

    it('setAdmin', async () => {
        await expect(positionRouter.connect(user0).setAdmin(user1.address)).to.be.revertedWith(`GovernableUnauthorizedAccount("${user0.address}")`)

        await positionRouter.transferGovernance(user0.address)
        await positionRouter.connect(user0).acceptGovernance()
    ...
    it('setDepositFee', async () => {
        await expect(positionRouter.connect(user0).setDepositFee(25)).to.be.revertedWith('BasePositionManager: forbidden')
    ...
    it('setIncreasePositionBufferBps', async () => {
        await expect(positionRouter.connect(user0).setIncreasePositionBufferBps(200)).to.be.revertedWith('BasePositionManager: forbidden')
    ...
    it('setReferralStorage', async () => {
        await expect(positionRouter.connect(user0).setReferralStorage(user1.address)).to.be.revertedWith('BasePositionManager: forbidden')
    ...
    it('setMaxGlobalSizes', async () => {
        ...
        await expect(positionRouter.connect(user0).setMaxGlobalSizes(tokens, maxGlobalLongSizes, maxGlobalShortSizes)).to.be.revertedWith(
    ...
    it('withdrawFees', async () => {
        ...
        await expect(positionRouter.connect(user2).withdrawFees(dai.address, user3.address)).to.be.revertedWith('BasePositionManager: forbidden')
    ...
    it('approve', async () => {
        await expect(positionRouter.connect(user0).approve(bnb.address, user1.address, 100)).to.be.revertedWith(
    ...
    it('sendValue', async () => {
        await expect(positionRouter.connect(user0).sendValue(user1.address, 0)).to.be.revertedWith(`GovernableUnauthorizedAccount("${user0.address}")`)
    ...
    it('setPositionKeeper', async () => {
        await expect(positionRouter.connect(user0).setPositionKeeper(user1.address, true)).to.be.revertedWith('BasePositionManager: forbidden')
    ...
    it('setMinExecutionFee', async () => {
        await expect(positionRouter.connect(user0).setMinExecutionFee('7000')).to.be.revertedWith('BasePositionManager: forbidden')
    ...
    it('setIsLeverageEnabled', async () => {
        await expect(positionRouter.connect(user0).setIsLeverageEnabled(false)).to.be.revertedWith('BasePositionManager: forbidden')
    ...
    it('setDelayValues', async () => {
        await expect(positionRouter.connect(user0).setDelayValues(7, 21, 600)).to.be.revertedWith('BasePositionManager: forbidden')
    ...
    it('setRequestKeysStartValues', async () => {
        await expect(positionRouter.connect(user0).setRequestKeysStartValues(5, 8)).to.be.revertedWith('BasePositionManager: forbidden')
    ...
    it('increasePosition acceptablePrice long', async () => {
        ...
        await positionRouter.connect(user0).createIncreasePosition(...params.concat([4000, referralCode]), { value: 4000 })
        await expect(positionRouter.connect(positionKeeper).executeIncreasePosition(key, executionFeeReceiver.address)).to.be.revertedWith(
    ...
    it('validateExecution', async () => {
        ...
        await expect(positionRouter.connect(user1).executeIncreasePosition(key, executionFeeReceiver.address)).to.be.revertedWith('PositionRouter: forbidden')

        await expect(positionRouter.connect(user0).executeIncreasePosition(key, executionFeeReceiver.address)).to.be.revertedWith(
    ...
    it('validateCancellation', async () => {
        ...
        await expect(positionRouter.connect(user1).cancelIncreasePosition(key, executionFeeReceiver.address)).to.be.revertedWith('PositionRouter: forbidden')

        await expect(positionRouter.connect(user0).cancelIncreasePosition(key, executionFeeReceiver.address)).to.be.revertedWith(
            'PositionRouter: min delay not yet passed'
        )
    ...
    it('maxGlobalLongSize', async () => {
        ...
        await timeLock.setContractHandler(positionRouter.address, true)
        await timeLock.setShouldToggleIsLeverageEnabled(true)
        await positionRouter.setMaxGlobalSizes([bnb.address, btc.address], [toUsd(5000), toUsd(10000)], [0, 0])
        ...
        let key = await positionRouter.getRequestKey(user0.address, 1)
        await expect(positionRouter.connect(positionKeeper).executeIncreasePosition(key, executionFeeReceiver.address)).to.be.revertedWith(
            'BasePositionManager: max global longs exceeded'
        )

        await positionRouter.setMaxGlobalSizes([bnb.address, btc.address], [toUsd(6000), toUsd(10000)], [0, 0])
    ...
    it('decreasePosition acceptablePrice long', async () => {
        ...
        await expect(positionRouter.connect(positionKeeper).executeDecreasePosition(key, executionFeeReceiver.address)).to.be.revertedWith(
    ...
    it('maxGlobalShortSize', async () => {
        ...
        await positionRouter.setMaxGlobalSizes([bnb.address, btc.address], [0, 0], [toUsd(5000), toUsd(10000)])
        ...
        await positionRouter.connect(user0).createIncreasePosition(...params.concat([4000, referralCode]), { value: 4000 })
        await expect(positionRouter.connect(positionKeeper).executeIncreasePosition(key, executionFeeReceiver.address)).to.be.revertedWith(
            'BasePositionManager: max global shorts exceeded'
        )

        await positionRouter.setMaxGlobalSizes([bnb.address, btc.address], [0, 0], [toUsd(6000), toUsd(10000)])
    ...
    it('createIncreasePosition, executeIncreasePosition, cancelIncreasePosition', async () => {
        ...
        await expect(positionRouter.connect(user0).createIncreasePosition(...params.concat([3000, referralCode]))).to.be.revertedWith(
            'PositionRouter: invalid executionFee'
        )

        await expect(positionRouter.connect(user0).createIncreasePosition(...params.concat([4000, referralCode]))).to.be.revertedWith(
            'PositionRouter: invalid msg.value'
        )

        await expect(positionRouter.connect(user0).createIncreasePosition(...params.concat([4000, referralCode]), { value: 3000 })).to.be.revertedWith(
            'PositionRouter: invalid msg.value'
        )

        params[0] = []
        await expect(positionRouter.connect(user0).createIncreasePosition(...params.concat([4000, referralCode]), { value: 4000 })).to.be.revertedWith(
    ...
    it('createIncreasePositionETH, executeIncreasePosition, cancelIncreasePosition', async () => {
        ...
        await expect(positionRouter.connect(user0).createIncreasePositionETH(...params.concat([3000, referralCode]))).to.be.revertedWith(
            'PositionRouter: invalid executionFee'
        )

        await expect(positionRouter.connect(user0).createIncreasePositionETH(...params.concat([4000, referralCode])), { value: 3000 }).to.be.revertedWith(
            'PositionRouter: invalid msg.value'
        )

        await expect(positionRouter.connect(user0).createIncreasePositionETH(...params.concat([4000, referralCode]), { value: 4000 })).to.be.revertedWith(
        ...
        const tx = await positionRouter
            .connect(user0)
            .createIncreasePositionETH(...params.concat([4000, referralCode]), { value: expandDecimals(1, 18).add(4000) })
    ...
    it('createIncreasePosition, createDecreasePosition, executeDecreasePosition, cancelDecreasePosition', async () => {
        ...
        await expect(positionRouter.connect(user0).createDecreasePosition(...decreasePositionParams.concat([3000, false]))).to.be.revertedWith(
            'PositionRouter: invalid executionFee'
        )

        await expect(positionRouter.connect(user0).createDecreasePosition(...decreasePositionParams.concat([4000, false]))).to.be.revertedWith(
            'PositionRouter: invalid msg.value'
        )

        await expect(positionRouter.connect(user0).createDecreasePosition(...decreasePositionParams.concat([4000, false]), { value: 3000 })).to.be.revertedWith(
            'PositionRouter: invalid msg.value'
        )
        ...
        await expect(positionRouter.connect(user0).createDecreasePosition(...decreasePositionParams.concat([4000, true]), { value: 4000 })).to.be.revertedWith(
            'PositionRouter: invalid _path'
        )
    ...
    it('executeIncreasePositions, executeDecreasePositions', async () => {
        ...
        await expect(positionRouter.connect(positionKeeper).executeIncreasePositions(100, executionFeeReceiver.address)).to.be.revertedWith(
            'PositionRouter: forbidden'
        )

        await expect(positionRouter.connect(positionKeeper).executeDecreasePositions(100, executionFeeReceiver.address)).to.be.revertedWith(
            'PositionRouter: forbidden'
        )
        ...
        await expect(positionRouter.connect(positionKeeper).executeIncreasePosition(key3, executionFeeReceiver.address)).to.be.revertedWith(
        ...
        await positionRouter
            .connect(user0)
            .createDecreasePosition(...decreasePositionParams.concat([user0.address, 0, toUsd(290), 4000, false]), { value: 4000 })
        ...
        await positionRouter
            .connect(user1)
            .createDecreasePosition(...decreasePositionParams.concat([user1.address, 0, toUsd(290), 4000, false]), { value: 4000 })
        ...
        await positionRouter
            .connect(user2)
            .createDecreasePosition(...decreasePositionParams.concat([user2.address, 0, toUsd(290), 4000, false]), { value: 4000 })
        ...
        await positionRouter
            .connect(user3)
            .createDecreasePosition(...decreasePositionParams.concat([user3.address, 0, toUsd(290), 4000, false]), { value: 4000 })
        ...
        await positionRouter
            .connect(user4)
            .createDecreasePosition(...decreasePositionParams.concat([user4.address, 0, toUsd(290), 4000, false]), { value: 4000 })
        ...
        await expect(positionRouter.connect(positionKeeper).executeDecreasePosition(decreaseKey3, executionFeeReceiver.address)).to.be.revertedWith(
        ...
        await positionRouter
            .connect(user0)
            .createDecreasePosition(...decreasePositionParams.concat([user0.address, toUsd(290), 0, 4000, false]), { value: 4000 })
        await positionRouter
            .connect(user0)
            .createDecreasePosition(...decreasePositionParams.concat([user0.address, toUsd(290), 0, 4000, false]), { value: 4000 })
