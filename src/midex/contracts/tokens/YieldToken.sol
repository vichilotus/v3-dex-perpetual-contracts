...
contract YieldToken is IERC20, IYieldToken, Governable {
    ...
    function setInWhitelistMode(bool _inWhitelistMode) external onlyGovernor {
        inWhitelistMode = _inWhitelistMode;
    }

    function setWhitelistedHandler(address _handler, bool _isWhitelisted) external onlyGovernor {
