...
import {IWETH10, IERC3156FlashBorrower, IApprovalReceiver, ITransferReceiver} from './interfaces/IWrappedEtherV10.sol';
...
contract WrappedETH is IWETH10 {
    ...
    bytes32 public immutable PERMIT_TYPE_HASH = keccak256('Permit(address owner,address spender,uint256 value,uint256 nonce,uint256 deadline)');
    ...
    function permit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) external override {
        ...
        bytes32 hashStruct = keccak256(abi.encode(PERMIT_TYPE_HASH, owner, spender, value, nonces[owner]++, deadline));
